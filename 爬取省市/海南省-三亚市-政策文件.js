...
// t1('http://syipb.sanya.gov.cn/tzcjjsite/zcwj/list.shtml')
// t2('http://syipb.sanya.gov.cn/tzcjjsite/zcwj/list.shtml')
// t3('https://www.hiipb.com/news/show-26462.html')
module.exports = {
    t1,
    t2,
    t3,
    location: '海南省-三亚市',
    tag: "政策文件",
    homeUrl: 'http://syipb.sanya.gov.cn/tzcjjsite/zcwj/list.shtml'
}   